...
import { Eye, EyeOff, Loader, Loader2, Lock, Mail, MessageSquareMore, User } from "lucide-react";
...
const SignUpPage = () => {
  ...
  const verifySignUp=()=>
  {
    ...
    if(!formData.password.trim())return toast.error("Password is required");
     ...
     if(formData.password.length < 7) return toast.error("Password must be at least 7 characters long");
     return true;
  };
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              >
                <TiMessages className="w-6 h-6 text-primary" />
              </div>
          ...
          <div className="space-y-6">
            ...
            <button type="submit" className="btn btn-primary w-full py-5 rounded-lg text-white" disabled={isSigningUp} >
              {isSigningUp ?(
                <>
